class MWSTMarker{
	...
	isMWST(questionGraph, studentGraph){
    	var answerWeight = this.Prim(questionGraph);
	...
	Prim(graph) { // Function that takes in an adjacency matrix representation of a graph, and finds the cost of the MWST
