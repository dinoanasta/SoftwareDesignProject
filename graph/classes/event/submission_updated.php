...
/**
 * The assignsubmission_graph submission_updated event.
 *
...
/**
 * The assignsubmission_graph submission_updated event class.
 *
...
class submission_updated extends \mod_assign\event\submission_updated {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' updated a answerGraph submission in the assignment with course module id " .
