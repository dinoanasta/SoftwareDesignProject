...
namespace assignsubmission_graph\privacy;
...
class provider implements
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($requestdata->get_context()->id, 'assignsubmission_graph',
                ASSIGNSUBMISSION_graph_FILEAREA);

        // Delete the records in the table.
        $DB->delete_records('assignsubmission_graph', ['assignment' => $requestdata->get_assignid()]);
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $deletedata) {
        ...
        // Delete related files.
        $fs = get_file_storage();
        $fs->delete_area_files($deletedata->get_context()->id, 'assignsubmission_graph', ASSIGNSUBMISSION_graph_FILEAREA,
                $submissionid);

        // Delete the records in the table.
        $DB->delete_records('assignsubmission_graph', ['assignment' => $deletedata->get_assignid(),
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        ...
        $fs->delete_area_files_select($deletedata->get_context()->id,
                'assignsubmission_graph', ASSIGNSUBMISSION_graph_FILEAREA, $sql, $params);

        $params['assignid'] = $deletedata->get_assignid();
        $DB->delete_records_select('assignsubmission_graph', "assignment = :assignid AND submission $sql", $params);
    }
}
