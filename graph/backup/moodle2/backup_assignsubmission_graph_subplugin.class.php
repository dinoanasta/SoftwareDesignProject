 ...
 * @package assignsubmission_graph
 */
class backup_assignsubmission_graph_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement->set_source_table('assignsubmission_graph',
                                          array('submission' => backup::VAR_PARENTID));

        $subpluginelement->annotate_files('assignsubmission_graph',
                                          'submissions_graph',
                                          'submission');
        return $subplugin;
    }
