...
/**
 * Unit tests for assignsubmission_graph.
 *
...
/**
 * Unit tests for mod/assign/submission/answerGraph/classes/privacy/
 *
 * @copyright  2018 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignsubmission_online_privacy_testcase extends \mod_assign\tests\mod_assign_privacy_testcase {
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('assignsubmission_graph');
        $collection = \assignsubmission_graph\privacy\provider::get_metadata($collection);
    ...
    public function test_export_submission_user_data() {
        ...
        \assignsubmission_graph\privacy\provider::export_submission_user_data($exportdata);
        $this->assertEquals($submissiontext, $writer->get_data(['Attempt 1',
                get_string('privacy:path', 'assignsubmission_graph')])->text);
    }
    ...
    public function test_delete_submission_for_context() {
        ...
        \assignsubmission_graph\privacy\provider::delete_submission_for_context($requestdata);
    ...
    public function test_delete_submission_for_userid() {
        ...
        \assignsubmission_graph\privacy\provider::delete_submission_for_userid($requestdata);
    ...
    public function test_delete_submissions() {
        ...
        $data = $DB->get_records('assignsubmission_graph', ['assignment' => $assign1->get_instance()->id]);
        ...
        \assignsubmission_graph\privacy\provider::delete_submissions($requestdata);
        ...
        $data = $DB->get_records('assignsubmission_graph', ['assignment' => $assign2->get_instance()->id]);
